...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rules = {"keys": ["one","two","few","many","other"], "rule": function(n) { return (function() { if (n == 1) { return "one" } else { return (function() { if (n == 2) { return "two" } else { return (function() { if ([3, 4, 5, 6].indexOf(n) >= 0) { return "few" } else { return (function() { if ([7, 8, 9, 10].indexOf(n) >= 0) { return "many" } else { return "other" } })(); } })(); } })(); } })(); }};
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} second ago","two":"{0} second ago","few":"{0} second ago","many":"{0} second ago","other":"{0} seconds ago"}},"minute":{"default":{"one":"{0} minute ago","two":"{0} minute ago","few":"{0} minute ago","many":"{0} minute ago","other":"{0} minutes ago"}},"hour":{"default":{"one":"{0} hour ago","two":"{0} hour ago","few":"{0} hour ago","many":"{0} hour ago","other":"{0} hours ago"}},"day":{"default":{"one":"{0} day ago","two":"{0} day ago","few":"{0} day ago","many":"{0} day ago","other":"{0} days ago"}},"week":{"default":{"one":"{0} week ago","two":"{0} week ago","few":"{0} week ago","many":"{0} week ago","other":"{0} weeks ago"}},"month":{"default":{"one":"{0} month ago","two":"{0} month ago","few":"{0} month ago","many":"{0} month ago","other":"{0} months ago"}},"year":{"default":{"one":"{0} year ago","two":"{0} year ago","few":"{0} year ago","many":"{0} year ago","other":"{0} years ago"}}},"until":{"second":{"default":{"one":"In {0} second","two":"In {0} second","few":"In {0} second","many":"In {0} second","other":"In {0} seconds"}},"minute":{"default":{"one":"In {0} minute","two":"In {0} minute","few":"In {0} minute","many":"In {0} minute","other":"In {0} minutes"}},"hour":{"default":{"one":"In {0} hour","two":"In {0} hour","few":"In {0} hour","many":"In {0} hour","other":"In {0} hours"}},"day":{"default":{"one":"In {0} day","two":"In {0} day","few":"In {0} day","many":"In {0} day","other":"In {0} days"}},"week":{"default":{"one":"In {0} week","two":"In {0} week","few":"In {0} week","many":"In {0} week","other":"In {0} weeks"}},"month":{"default":{"one":"In {0} month","two":"In {0} month","few":"In {0} month","many":"In {0} month","other":"In {0} months"}},"year":{"default":{"one":"In {0} year","two":"In {0} year","few":"In {0} year","many":"In {0} year","other":"In {0} years"}}},"none":{"second":{"default":{"one":"{0} second","two":"{0} second","few":"{0} second","many":"{0} second","other":"{0} seconds"},"short":{"one":"{0} sec","two":"{0} sec","few":"{0} sec","many":"{0} sec","other":"{0} secs"},"abbreviated":{"one":"{0}s","two":"{0}s","few":"{0}s","many":"{0}s","other":"{0}s"}},"minute":{"default":{"one":"{0} minute","two":"{0} minute","few":"{0} minute","many":"{0} minute","other":"{0} minutes"},"short":{"one":"{0} min","two":"{0} min","few":"{0} min","many":"{0} min","other":"{0} mins"},"abbreviated":{"one":"{0}m","two":"{0}m","few":"{0}m","many":"{0}m","other":"{0}m"}},"hour":{"default":{"one":"{0} hour","two":"{0} hour","few":"{0} hour","many":"{0} hour","other":"{0} hours"},"short":{"one":"{0} hr","two":"{0} hr","few":"{0} hr","many":"{0} hr","other":"{0} hrs"}},"day":{"default":{"one":"{0} day","two":"{0} day","few":"{0} day","many":"{0} day","other":"{0} days"},"short":{"one":"{0} day","two":"{0} day","few":"{0} day","many":"{0} day","other":"{0} days"},"abbreviated":{"one":"{0}d","two":"{0}d","few":"{0}d","many":"{0}d","other":"{0}d"}},"week":{"default":{"one":"{0} week","two":"{0} week","few":"{0} week","many":"{0} week","other":"{0} weeks"},"short":{"one":"{0} wk","two":"{0} wk","few":"{0} wk","many":"{0} wk","other":"{0} wks"}},"month":{"default":{"one":"{0} month","two":"{0} month","few":"{0} month","many":"{0} month","other":"{0} months"},"short":{"one":"{0} mth","two":"{0} mth","few":"{0} mth","many":"{0} mth","other":"{0} mths"}},"year":{"default":{"one":"{0} year","two":"{0} year","few":"{0} year","many":"{0} year","other":"{0} years"},"short":{"one":"{0} yr","two":"{0} yr","few":"{0} yr","many":"{0} yr","other":"{0} yrs"}}}};
  ...
  TwitterCldr.Calendar = (function() {
    ...
    Calendar.calendar = {"additional_formats":{"EHm":"E HH:mm","EHms":"E HH:mm:ss","Ed":"d E","Ehm":"E h:mm a","Ehms":"E h:mm:ss a","Gy":"y G","GyMMM":"MMM y G","GyMMMEd":"E, MMM d, y G","GyMMMd":"MMM d, y G","H":"HH","Hm":"HH:mm","Hms":"HH:mm:ss","M":"L","MEd":"E, M/d","MMM":"LLL","MMMEd":"E, MMM d","MMMd":"MMM d","Md":"M/d","d":"d","h":"h a","hm":"h:mm a","hms":"h:mm:ss a","ms":"mm:ss","y":"y","yM":"M/y","yMEd":"E, M/d/y","yMMM":"MMM y","yMMMEd":"E, MMM d, y","yMMMd":"MMM d, y","yMd":"M/d/y","yQQQ":"QQQ y","yQQQQ":"QQQQ y"},"days":{"format":{"abbreviated":{"fri":"Aoine","mon":"Luan","sat":"Sath","sun":"Domh","thu":"Déar","tue":"Máirt","wed":"Céad"},"narrow":"calendars.gregorian.days.stand-alone.narrow","short":{"fri":"Fr","mon":"Mo","sat":"Sa","sun":"Su","thu":"Th","tue":"Tu","wed":"We"},"wide":{"fri":"Dé hAoine","mon":"Dé Luain","sat":"Dé Sathairn","sun":"Dé Domhnaigh","thu":"Déardaoin","tue":"Dé Máirt","wed":"Dé Céadaoin"}},"stand-alone":{"abbreviated":"calendars.gregorian.days.format.abbreviated","narrow":{"fri":"A","mon":"L","sat":"S","sun":"D","thu":"D","tue":"M","wed":"C"},"short":"calendars.gregorian.days.format.short","wide":"calendars.gregorian.days.format.wide"}},"eras":{"abbr":{"0":"RC","1":"AD"},"name":{"0":"Roimh Chríost","1":"Anno Domini"},"narrow":{"0":"B","1":"A"}},"fields":{"day":"Lá","dayperiod":"a.m./p.m.","era":"Ré","hour":"Uair","minute":"Nóiméad","month":"Mí","second":"Soicind","week":"Seachtain","weekday":"Lá na seachtaine","year":"Bliain","zone":"Crios"},"formats":{"date":{"full":{"pattern":"EEEE d MMMM y"},"long":{"pattern":"d MMMM y"},"medium":{"pattern":"d MMM y"},"short":{"pattern":"dd/MM/y"}},"datetime":{"full":{"pattern":"{{date}} 'at' {{time}}"},"long":{"pattern":"{{date}} 'at' {{time}}"},"medium":{"pattern":"{{date}}, {{time}}"},"short":{"pattern":"{{date}}, {{time}}"}},"time":{"full":{"pattern":"HH:mm:ss zzzz"},"long":{"pattern":"HH:mm:ss z"},"medium":{"pattern":"HH:mm:ss"},"short":{"pattern":"HH:mm"}}},"months":{"format":{"abbreviated":{"1":"Ean","10":"DFómh","11":"Samh","12":"Noll","2":"Feabh","3":"Márta","4":"Aib","5":"Beal","6":"Meith","7":"Iúil","8":"Lún","9":"MFómh"},"narrow":"calendars.gregorian.months.stand-alone.narrow","wide":{"1":"Eanáir","10":"Deireadh Fómhair","11":"Samhain","12":"Nollaig","2":"Feabhra","3":"Márta","4":"Aibreán","5":"Bealtaine","6":"Meitheamh","7":"Iúil","8":"Lúnasa","9":"Meán Fómhair"}},"stand-alone":{"abbreviated":"calendars.gregorian.months.format.abbreviated","narrow":{"1":"E","10":"D","11":"S","12":"N","2":"F","3":"M","4":"A","5":"B","6":"M","7":"I","8":"L","9":"M"},"wide":"calendars.gregorian.months.format.wide"}},"periods":{"format":{"abbreviated":"calendars.gregorian.dayPeriods.format.wide","narrow":{"am":"a","noon":"n","pm":"p"},"wide":{"am":"a.m.","noon":"noon","pm":"p.m.","variant":{"am":"a.m.","pm":"p.m."}}},"stand-alone":{}},"quarters":{"format":{"abbreviated":{"1":"R1","2":"R2","3":"R3","4":"R4"},"narrow":"calendars.gregorian.quarters.stand-alone.narrow","wide":{"1":"1ú ráithe","2":"2ú ráithe","3":"3ú ráithe","4":"4ú ráithe"}},"stand-alone":{"abbreviated":"calendars.gregorian.quarters.format.abbreviated","narrow":{"1":1,"2":2,"3":3,"4":4},"wide":"calendars.gregorian.quarters.format.wide"}}};
