...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rules = {"keys": ["one","few","many","other"], "rule": function(n) { return (function() { if (n == 1) { return "one" } else { return (function() { if ([2, 3, 4].indexOf(n % 10) >= 0 && !([12, 13, 14].indexOf(n % 100) >= 0)) { return "few" } else { return (function() { if (!(n == 1) && [0, 1].indexOf(n % 10) >= 0 || [5, 6, 7, 8, 9].indexOf(n % 10) >= 0 || [12, 13, 14].indexOf(n % 100) >= 0) { return "many" } else { return "other" } })(); } })(); } })(); }};
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} sekundę temu","few":"{0} sekundy temu","many":"{0} sekund temu","other":"{0} sekundy temu"}},"minute":{"default":{"one":"{0} minutę temu","few":"{0} minuty temu","many":"{0} minut temu","other":"{0} minuty temu"}},"hour":{"default":{"one":"{0} godzinę temu","few":"{0} godziny temu","many":"{0} godzin temu","other":"{0} godziny temu"}},"day":{"default":{"one":"{0} dzień temu","few":"{0} dni temu","many":"{0} dni temu","other":"{0} dnia temu"}},"week":{"default":{"one":"{0} tydzień temu","few":"{0} tygodnie temu","many":"{0} tygodni temu","other":"{0} tygodnia temu"}},"month":{"default":{"one":"{0} miesiąc temu","few":"{0} miesiące temu","many":"{0} miesięcy temu","other":"{0} miesiąca temu"}},"year":{"default":{"one":"{0} rok temu","few":"{0} lata temu","many":"{0} lat temu","other":"{0} roku temu"}}},"until":{"second":{"default":{"one":"Za {0} sekundę","few":"Za {0} sekundy","many":"Za {0} sekund","other":"Za {0} sekundy"}},"minute":{"default":{"one":"Za {0} minutę","few":"Za {0} minuty","many":"Za {0} minut","other":"Za {0} minuty"}},"hour":{"default":{"one":"Za {0} godzinę","few":"Za {0} godziny","many":"Za {0} godzin","other":"Za {0} godziny"}},"day":{"default":{"one":"Za {0} dzień","few":"Za {0} dni","many":"Za {0} dni","other":"Za {0} dnia"}},"week":{"default":{"one":"Za {0} tydzień","few":"Za {0} tygodnie","many":"Za {0} tygodni","other":"Za {0} tygodnia"}},"month":{"default":{"one":"Za {0} miesiąc","few":"Za {0} miesiące","many":"Za {0} miesięcy","other":"Za {0} miesiąca"}},"year":{"default":{"one":"Za {0} rok","few":"Za {0} lata","many":"Za {0} lat","other":"Za {0} roku"}}},"none":{"second":{"default":{"one":"{0} sekunda","few":"{0} sekundy","many":"{0} sekund","other":"{0} sekund"},"short":{"one":"{0} sek.","few":"{0} sek.","many":"{0} sek.","other":"{0} sek."},"abbreviated":{"one":"{0}s","few":"{0}s","many":"{0}s","other":"{0}s"}},"minute":{"default":{"one":"{0} minuta","few":"{0} minuty","many":"{0} minut","other":"{0} minuty"},"short":{"one":"{0} min.","few":"{0} min.","many":"{0} min.","other":"{0} min."},"abbreviated":{"one":"{0} min","few":"{0} min","many":"{0} min","other":"{0} min"}},"hour":{"default":{"one":"{0} godzina","few":"{0} godziny","many":"{0} godzin","other":"{0} godzin"},"short":{"one":"{0} godz.","few":"{0} godz.","many":"{0} godz.","other":"{0} godz."},"abbreviated":{"one":"{0}godz.","few":"{0}godz.","many":"{0}godz.","other":"{0}godz."}},"day":{"default":{"one":"{0} dzień","few":"{0} dni","many":"{0} dni","other":"{0} dnia"},"short":{"one":"{0} dzień","few":"{0} dni","many":"{0} dni","other":"{0} dnia"},"abbreviated":{"one":"{0}dni","few":"{0}dni","many":"{0}dni","other":"{0}dni"}},"week":{"default":{"one":"{0} tydzień","few":"{0} tygodnie","many":"{0} tygodni","other":"{0} tygodnia"},"short":{"one":"{0} tydz.","few":"{0} tyg.","many":"{0} tyg.","other":"{0} tyg."}},"month":{"default":{"one":"{0} miesiąc","few":"{0} miesiące","many":"{0} miesięcy","other":"{0} miesiąca"},"short":{"one":"{0} mies.","few":"{0} mies.","many":"{0} mies.","other":"{0} mies."}},"year":{"default":{"one":"{0} rok","few":"{0} lata","many":"{0} lat","other":"{0} roku"},"short":{"one":"{0} rok","few":"{0} lata","many":"{0} lat","other":"{0} roku"}}}};
  ...
  TwitterCldr.NumberFormatter = (function() {
    function NumberFormatter() {
      this.all_tokens = {"default":{"positive":["","#,##0.###"],"negative":["-","#,##0.###"]},"decimal":{"positive":["","#,##0.###"],"negative":["-","#,##0.###"]},"long_decimal":{"positive":{"1000":["","0"," tysiąca"],"10000":["","00"," tysiąca"],"100000":["","000"," tysiąca"],"1000000":["","0"," miliona"],"10000000":["","00"," miliona"],"100000000":["","000"," miliona"],"1000000000":["","0"," miliarda"],"10000000000":["","00"," miliarda"],"100000000000":["","000"," miliarda"],"1000000000000":["","0"," biliona"],"10000000000000":["","00"," biliona"],"100000000000000":["","000"," biliona"]},"negative":{"1000":["-","0"," tysiąca"],"10000":["-","00"," tysiąca"],"100000":["-","000"," tysiąca"],"1000000":["-","0"," miliona"],"10000000":["-","00"," miliona"],"100000000":["-","000"," miliona"],"1000000000":["-","0"," miliarda"],"10000000000":["-","00"," miliarda"],"100000000000":["-","000"," miliarda"],"1000000000000":["-","0"," biliona"],"10000000000000":["-","00"," biliona"],"100000000000000":["-","000"," biliona"]}},"short_decimal":{"positive":{"1000":["","0"," tys."],"10000":["","00"," tys."],"100000":["","000"," tys."],"1000000":["","0"," mln"],"10000000":["","00"," mln"],"100000000":["","000"," mln"],"1000000000":["","0"," mld"],"10000000000":["","00"," mld"],"100000000000":["","000"," mld"],"1000000000000":["","0"," bln"],"10000000000000":["","00"," bln"],"100000000000000":["","000"," bln"]},"negative":{"1000":["-","0"," tys."],"10000":["-","00"," tys."],"100000":["-","000"," tys."],"1000000":["-","0"," mln"],"10000000":["-","00"," mln"],"100000000":["-","000"," mln"],"1000000000":["-","0"," mld"],"10000000000":["-","00"," mld"],"100000000000":["-","000"," mld"],"1000000000000":["-","0"," bln"],"10000000000000":["-","00"," bln"],"100000000000000":["-","000"," bln"]}},"currency":{"positive":["","#,##0.00"," ¤"],"negative":["(","#,##0.00"," ¤)"]},"percent":{"positive":["","#,##0","%"],"negative":["-","#,##0","%"]}};
      this.tokens = [];
  ...
  TwitterCldr.Calendar = (function() {
    ...
    Calendar.calendar = {"additional_formats":{"EHm":"E, HH:mm","EHms":"E, HH:mm:ss","Ed":"E, d","Ehm":"E, h:mm a","Ehms":"E, h:mm:ss a","Gy":"y G","GyMMM":"MMM y G","GyMMMEd":"E, d MMM y G","GyMMMd":"d MMM y G","H":"HH","Hm":"HH:mm","Hms":"HH:mm:ss","M":"L","MEd":"E, d.MM","MMM":"LLL","MMMEd":"E, d MMM","MMMMd":"d MMMM","MMMd":"d MMM","MMdd":"d.MM","Md":"d.MM","d":"d","h":"h a","hm":"h:mm a","hms":"h:mm:ss a","ms":"mm:ss","y":"y","yM":"MM.y","yMEd":"E, d.MM.y","yMM":"MM.y","yMMM":"LLL y","yMMMEd":"E, d MMM y","yMMMM":"LLLL y","yMMMd":"d MMM y","yMd":"d.MM.y","yQQQ":"QQQ y","yQQQQ":"QQQQ y"},"days":{"format":{"abbreviated":{"fri":"pt.","mon":"pon.","sat":"sob.","sun":"niedz.","thu":"czw.","tue":"wt.","wed":"śr."},"narrow":{"fri":"P","mon":"P","sat":"S","sun":"N","thu":"C","tue":"W","wed":"Ś"},"short":{"fri":"pt.","mon":"pon.","sat":"sob.","sun":"niedz.","thu":"czw.","tue":"wt.","wed":"śr."},"wide":{"fri":"piątek","mon":"poniedziałek","sat":"sobota","sun":"niedziela","thu":"czwartek","tue":"wtorek","wed":"środa"}},"stand-alone":{"abbreviated":{"fri":"pt.","mon":"pon.","sat":"sob.","sun":"niedz.","thu":"czw.","tue":"wt.","wed":"śr."},"narrow":{"fri":"P","mon":"P","sat":"S","sun":"N","thu":"C","tue":"W","wed":"Ś"},"short":{"fri":"pt.","mon":"pon.","sat":"sob.","sun":"niedz.","thu":"czw.","tue":"wt.","wed":"śr."},"wide":{"fri":"piątek","mon":"poniedziałek","sat":"sobota","sun":"niedziela","thu":"czwartek","tue":"wtorek","wed":"środa"}}},"eras":{"abbr":{"0":"p.n.e.","1":"n.e."},"name":{"0":"p.n.e.","1":"n.e."},"narrow":{"0":"B","1":"A"}},"fields":{"day":"dzień","dayperiod":"rano / po południu / wieczorem","era":"era","hour":"godzina","minute":"minuta","month":"miesiąc","second":"sekunda","week":"tydzień","weekday":"dzień tygodnia","year":"rok","zone":"strefa czasowa"},"formats":{"date":{"full":{"pattern":"EEEE, d MMMM y"},"long":{"pattern":"d MMMM y"},"medium":{"pattern":"d MMM y"},"short":{"pattern":"dd.MM.y"}},"datetime":{"full":{"pattern":"{{date}} {{time}}"},"long":{"pattern":"{{date}} {{time}}"},"medium":{"pattern":"{{date}}, {{time}}"},"short":{"pattern":"{{date}}, {{time}}"}},"time":{"full":{"pattern":"HH:mm:ss zzzz"},"long":{"pattern":"HH:mm:ss z"},"medium":{"pattern":"HH:mm:ss"},"short":{"pattern":"HH:mm"}}},"months":{"format":{"abbreviated":{"1":"sty","10":"paź","11":"lis","12":"gru","2":"lut","3":"mar","4":"kwi","5":"maj","6":"cze","7":"lip","8":"sie","9":"wrz"},"narrow":{"1":"s","10":"p","11":"l","12":"g","2":"l","3":"m","4":"k","5":"m","6":"c","7":"l","8":"s","9":"w"},"wide":{"1":"stycznia","10":"października","11":"listopada","12":"grudnia","2":"lutego","3":"marca","4":"kwietnia","5":"maja","6":"czerwca","7":"lipca","8":"sierpnia","9":"września"}},"stand-alone":{"abbreviated":{"1":"sty","10":"paź","11":"lis","12":"gru","2":"lut","3":"mar","4":"kwi","5":"maj","6":"cze","7":"lip","8":"sie","9":"wrz"},"narrow":{"1":"s","10":"p","11":"l","12":"g","2":"l","3":"m","4":"k","5":"m","6":"c","7":"l","8":"s","9":"w"},"wide":{"1":"styczeń","10":"październik","11":"listopad","12":"grudzień","2":"luty","3":"marzec","4":"kwiecień","5":"maj","6":"czerwiec","7":"lipiec","8":"sierpień","9":"wrzesień"}}},"periods":{"format":{"abbreviated":"calendars.gregorian.dayPeriods.format.wide","narrow":{"am":"a","noon":"n","pm":"p"},"wide":{"afternoon":"po południu","am":"AM","earlyMorning":"nad ranem","evening":"wieczorem","lateMorning":"przed południem","morning":"rano","night":"w nocy","noon":"w południe","pm":"PM","variant":{"am":"a.m.","pm":"p.m."}}},"stand-alone":{}},"quarters":{"format":{"abbreviated":{"1":"K1","2":"K2","3":"K3","4":"K4"},"narrow":{"1":1,"2":2,"3":3,"4":4},"wide":{"1":"I kwartał","2":"II kwartał","3":"III kwartał","4":"IV kwartał"}},"stand-alone":{"abbreviated":{"1":"1 kw.","2":"2 kw.","3":"3 kw.","4":"4 kw."},"narrow":{"1":1,"2":2,"3":3,"4":4},"wide":{"1":"I kwartał","2":"II kwartał","3":"III kwartał","4":"IV kwartał"}}}};
  ...
  TwitterCldr.Languages = (function() {
    ...
    Languages.all = {"aa":"afar","ab":"abchaski","ace":"aceh","ach":"aczoli","ada":"adangme","ady":"adygejski","ae":"awestyjski","af":"afrikaans","afa":"afro-azjatycki","afh":"afrihili","agq":"aghem","ain":"ajnu","ak":"akan","akk":"akadyjski","ale":"aleucki","alg":"języki algonkin","alt":"południowoałtajski","am":"amharski","an":"aragoński","ang":"staroangielski","anp":"angika","apa":"język Apaczów","ar":"arabski","ar-001":"współczesny arabski","arc":"aramejski","arn":"araukański","arp":"arapaho","art":"sztuczny","arw":"arawak","as":"asamski","asa":"asu","ast":"asturyjski","ath":"język Atapasków","aus":"język australijski","av":"awarski","awa":"awadhi","ay":"ajmara","az":"azerski","ba":"baszkirski","bad":"język banda","bai":"język bamileke","bal":"beludżi","ban":"balijski","bas":"basa","bat":"bałtycki","bax":"bamum","bbj":"ghomala","be":"białoruski","bej":"bedża","bem":"bemba","ber":"berberski","bez":"bena","bfd":"bafut","bg":"bułgarski","bh":"biharski","bho":"bhodźpuri","bi":"bislama","bik":"bikol","bin":"bini","bkm":"kom","bla":"siksika","bm":"bambara","bn":"bengalski","bnt":"bantu","bo":"tybetański","br":"bretoński","bra":"bradź","brx":"bodo","bs":"bośniacki","bss":"akose","btk":"batak","bua":"buriacki","bug":"bugiński","bum":"bulu","byn":"blin","byv":"medumba","ca":"kataloński","cad":"kaddo","cai":"język Indian środkowoamerykańskich","car":"karibi","cau":"kaukaski","cay":"kajuga","cch":"atsam","ce":"czeczeński","ceb":"cebuano","cel":"celtycki","cgg":"chiga","ch":"chamorro","chb":"czibcza","chg":"czagatajski","chk":"truk","chm":"maryjski","chn":"żargon Chinook","cho":"choctaw","chp":"chipewyan","chr":"czirokeski","chy":"język Czejenów","ckb":"sorani kurdyjski","cmc":"czam","co":"korsykański","cop":"koptyjski","cpe":"angielski kreolski lub pidżin","cpf":"francuski kreolski lub pidżin","cpp":"portugalski kreolski lub pidżin","cr":"kri","crh":"krymski turecki","crp":"kreolski lub pidżin","cs":"czeski","csb":"kaszubski","cu":"staro-cerkiewno-słowiański","cus":"kuszycki","cv":"czuwaski","cy":"walijski","da":"duński","dak":"dakota","dar":"dargwijski","dav":"taita","day":"dajak","de":"niemiecki","de-AT":"austriacki niemiecki","de-CH":"wysokoniemiecki (Szwajcaria)","del":"delaware","den":"slave","dgr":"dogrib","din":"dinka","dje":"dżerma","doi":"dogri","dra":"drawidyjski","dsb":"dolnołużycki","dua":"duala","dum":"średniowieczny niderlandzki","dv":"malediwski","dyo":"diola","dyu":"dyula","dz":"dzongkha","dzg":"dazaga","ebu":"embu","ee":"ewe","efi":"efik","egy":"starożytny egipski","eka":"ekajuk","el":"grecki","elx":"elamicki","en":"angielski","en-AU":"australijski angielski","en-CA":"kanadyjski angielski","en-GB":"brytyjski angielski","en-US":"angielski (USA)","enm":"średnioangielski","eo":"esperanto","es":"hiszpański","es-419":"amerykański hiszpański","es-ES":"europejski hiszpański","es-MX":"meksykański hiszpański","et":"estoński","eu":"baskijski","ewo":"ewondo","fa":"perski","fan":"fang","fat":"fanti","ff":"fulani","fi":"fiński","fil":"filipino","fiu":"ugrofiński","fj":"fidżijski","fo":"farerski","fon":"fon","fr":"francuski","fr-CA":"kanadyjski francuski","fr-CH":"szwajcarski francuski","frm":"średniofrancuski","fro":"starofrancuski","frr":"północnofryzyjski","frs":"fryzyjski wschodni","fur":"friulijski","fy":"zachodniofryzyjski","ga":"irlandzki","gaa":"ga","gay":"gayo","gba":"gbaya","gd":"szkocki gaelicki","gem":"germański","gez":"gyyz","gil":"gilbertański","gl":"galicyjski","gmh":"średnio-wysoko-niemiecki","gn":"guarani","goh":"staro-wysoko-niemiecki","gon":"gondi","gor":"gorontalo","got":"gocki","grb":"grebo","grc":"starogrecki","gsw":"szwajcarski niemiecki","gu":"gudźaracki","guz":"gusii","gv":"manx","gwi":"gwichʼin","ha":"hausa","hai":"haida","haw":"hawajski","he":"hebrajski","hi":"hindi","hil":"hiligajnon","him":"himachali","hit":"hetycki","hmn":"hmongijski","ho":"hiri motu","hr":"chorwacki","hsb":"górnołużycki","ht":"haitański","hu":"węgierski","hup":"hupa","hy":"ormiański","hz":"herero","ia":"interlingua","iba":"ibanag","ibb":"ibibio","id":"indonezyjski","ie":"interlingue","ig":"igbo","ii":"syczuański","ijo":"ijo","ik":"inupiak","ilo":"ilokano","inc":"indoaryjski","ine":"indoeuropejski","inh":"inguski","io":"ido","ira":"irański","iro":"irokeski","is":"islandzki","it":"włoski","iu":"inuktitut","ja":"japoński","jbo":"lojban","jgo":"Ngomba","jmc":"machame","jpr":"judeoperski","jrb":"judeoarabski","jv":"jawajski","ka":"gruziński","kaa":"karakałpacki","kab":"kabylski","kac":"kaczin","kaj":"jju","kam":"kamba","kar":"kareński","kaw":"kawi","kbd":"kabardyjski","kbl":"kanembu","kcg":"tyap","kde":"makonde","kea":"kreolski Wysp Zielonego Przylądka","kfo":"koro","kg":"kongo","kha":"khasi","khi":"khoisan","kho":"chotański","khq":"koyra chini","ki":"kikuju","kj":"kwanyama","kk":"kazachski","kkj":"kako","kl":"grenlandzki","kln":"kalenjin","km":"khmerski","kmb":"kimbundu","kn":"kannada","ko":"koreański","kok":"konkani","kos":"kosrae","kpe":"kpelle","kr":"kanuri","krc":"karaczajsko-bałkarski","krl":"karelski","kro":"kru","kru":"kurukh","ks":"kaszmirski","ksb":"sambala","ksf":"bafia","ksh":"gwara kolońska","ku":"kurdyjski","kum":"kumycki","kut":"kutenai","kv":"komi","kw":"kornijski","ky":"kirgiski","la":"łaciński","lad":"ladyński","lag":"langi","lah":"lahnda","lam":"lamba","lb":"luksemburski","lez":"lezgijski","lg":"ganda","li":"limburgijski","lkt":"Lakota","ln":"lingala","lo":"laotański","lol":"mongo","loz":"lozi","lt":"litewski","lu":"luba-katanga","lua":"luba-lulua","lui":"luiseno","lun":"lunda","luo":"luo","lus":"lushai","luy":"luhya","lv":"łotewski","mad":"madurajski","maf":"mafa","mag":"magahi","mai":"maithili","mak":"makasar","man":"mandingo","map":"austronezyjski","mas":"masajski","mde":"maba","mdf":"moksha","mdr":"mandar","men":"mende","mer":"meru","mfe":"kreolski Mauritiusa","mg":"malgaski","mga":"średnioirlandzki","mgh":"makua","mgo":"Meta'","mh":"marshall","mi":"maoryjski","mic":"micmac","min":"minangkabu","mis":"inny język","mk":"macedoński","mkh":"mon-khmer","ml":"malajalam","mn":"mongolski","mnc":"manchu","mni":"manipuryjski","mno":"manobo","mo":"mołdawski","moh":"mohawk","mos":"mossi","mr":"marathi","ms":"malajski","mt":"maltański","mua":"mundang","mul":"wiele języków","mun":"mundajski","mus":"creek","mwl":"mirandese","mwr":"marwari","my":"birmański","mye":"myene","myn":"język Majów","myv":"erzya","na":"nauru","nah":"nahuatl","nai":"język Indian północnoamerykańskich","nap":"neapolitański","naq":"nama","nb":"norweski (bokmål)","nd":"ndebele północny","nds":"dolnosaksoński","ne":"nepalski","new":"newarski","ng":"ndonga","nia":"nias","nic":"nigrokordofański","niu":"niue","nl":"niderlandzki","nl-BE":"flamandzki (Belgia)","nmg":"ngumba","nn":"norweski (nynorsk)","nnh":"ngiemboon","no":"norweski","nog":"nogajski","non":"staronordyjski","nqo":"n’ko","nr":"ndebele południowy","nso":"sotho północny","nub":"nubijski","nus":"nuer","nv":"nawaho","nwc":"newarski klasyczny","ny":"njandża","nym":"niamwezi","nyn":"nyankole","nyo":"nyoro","nzi":"nzema","oc":"prowansalski","oj":"odżibwa","om":"oromski","or":"orija","os":"osetyjski","osa":"osage","ota":"osmańsko-turecki","oto":"otomi","pa":"pendżabski","paa":"papuaski","pag":"pangasino","pal":"pahlavi","pam":"pampango","pap":"papiamento","pau":"palau","peo":"staroperski","phi":"filipiński","phn":"fenicki","pi":"palijski","pl":"polski","pon":"ponpejski","pra":"prakryty","pro":"staroprowansalski","ps":"pasztuński","pt":"portugalski","pt-BR":"brazylijski portugalski","pt-PT":"europejski portugalski","qu":"keczua","raj":"radźasthani","rap":"rapanui","rar":"rarotonga","rm":"retoromański","rn":"rundi","ro":"rumuński","roa":"romański","rof":"rombo","rom":"cygański","root":"język rdzenny","ru":"rosyjski","rup":"arumuński","rw":"kinya-ruanda","rwk":"rwa","sa":"sanskryt","sad":"sandawe","sah":"jakucki","sai":"język Indian południowoamerykańskich","sal":"salisz","sam":"samarytański aramejski","saq":"samburu","sas":"sasak","sat":"santali","sba":"ngambay","sbp":"sangu","sc":"sardyński","scn":"sycylijski","sco":"szkocki","sd":"sindhi","se":"lapoński północny","see":"seneka","seh":"sena","sel":"selkupski","sem":"semicki","ses":"koyraboro senni","sg":"sango","sga":"staroirlandzki","sgn":"migowy","sh":"serbsko-chorwacki","shi":"tashelhiyt","shn":"shan","shu":"arabski (Czad)","si":"syngaleski","sid":"sidamo","sio":"siouański","sit":"chińsko-tybetański","sk":"słowacki","sl":"słoweński","sla":"słowiański","sm":"samoański","sma":"lapoński południowy","smi":"lapoński","smj":"lapoński Lule","smn":"lapoński Inari","sms":"lapoński Skolt","sn":"szona","snk":"soninke","so":"somalijski","sog":"sogdyjski","son":"songhaj","sq":"albański","sr":"serbski","srn":"sranan tongo","srr":"serer","ss":"siswati","ssa":"nilosaharyjski","ssy":"saho","st":"sotho południowy","su":"sundajski","suk":"sukuma","sus":"susu","sux":"sumeryjski","sv":"szwedzki","sw":"suahili","swb":"komoryjski","swc":"kongijski suahili","syc":"syriacki","syr":"syryjski","ta":"tamilski","tai":"tai","te":"telugu","tem":"temne","teo":"ateso","ter":"tereno","tet":"tetum","tg":"tadżycki","th":"tajski","ti":"tigrinia","tig":"tigre","tiv":"tiw","tk":"turkmeński","tkl":"tokelau","tl":"tagalski","tlh":"klingoński","tli":"tlingit","tmh":"tamaszek","tn":"setswana","to":"tonga","tog":"tonga (Niasa)","tpi":"tok pisin","tr":"turecki","trv":"taroko","ts":"tsonga","tsi":"tsimshian","tt":"tatarski","tum":"tumbuka","tup":"tupi","tut":"ałtajski","tvl":"tuvalu","tw":"twi","twq":"tasawaq","ty":"tahitański","tyv":"tuwiński","tzm":"centralnomarokański tamazight","udm":"udmurcki","ug":"ujgurski","uga":"ugarycki","uk":"ukraiński","umb":"umbundu","und":"nieznany język","ur":"urdu","uz":"uzbecki","vai":"wai","ve":"venda","vi":"wietnamski","vo":"volapuk","vot":"wotiacki","vun":"vunjo","wa":"waloński","wae":"walser","wak":"wakasz","wal":"walamo","war":"waraj","was":"washo","wen":"łużycki","wo":"wolof","xal":"kałmucki","xh":"khosa","xog":"soga","yao":"yao","yap":"japski","yav":"yangben","ybb":"yemba","yi":"jidysz","yo":"joruba","ypk":"jupik","yue":"kantoński","za":"czuang","zap":"zapotecki","zbl":"bliss","zen":"zenaga","zgh":"zgh","zh":"chiński","zh-Hans":"chiński (uproszczony)","zh-Hant":"chiński (tradycyjny)","znd":"azande","zu":"zulu","zun":"zuni","zxx":"brak treści o charakterze językowym","zza":"zazaki"};
