...
(function() {
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"zero":"قبل {0} من الثواني","one":"قبل {0} من الثواني","two":"قبل ثانيتين","few":"قبل {0} ثوانِ","many":"قبل {0} ثانية","other":"قبل {0} من الثواني"}},"minute":{"default":{"zero":"قبل {0} من الدقائق","one":"قبل {0} من الدقائق","two":"قبل دقيقتين","few":"قبل {0} دقائق","many":"قبل {0} دقيقة","other":"قبل {0} من الدقائق"}},"hour":{"default":{"zero":"قبل {0} من الساعات","one":"قبل {0} من الساعات","two":"قبل ساعتين","few":"قبل {0} ساعات","many":"قبل {0} ساعة","other":"قبل {0} من الساعات"}},"day":{"default":{"zero":"قبل {0} من الأيام","one":"قبل {0} من الأيام","two":"قبل يومين","few":"قبل {0} أيام","many":"قبل {0} يومًا","other":"قبل {0} من الأيام"}},"week":{"default":{"zero":"قبل {0} من الأسابيع","one":"قبل {0} من الأسابيع","two":"قبل أسبوعين","few":"قبل {0} أسابيع","many":"قبل {0} أسبوعًا","other":"قبل {0} من الأسابيع"}},"month":{"default":{"zero":"قبل {0} من الشهور","one":"قبل {0} من الشهور","two":"قبل شهرين","few":"قبل {0} أشهر","many":"قبل {0} شهرًا","other":"قبل {0} من الشهور"}},"year":{"default":{"zero":"قبل {0} من السنوات","one":"قبل {0} من السنوات","two":"قبل سنتين","few":"قبل {0} سنوات","many":"قبل {0} سنة","other":"قبل {0} من السنوات"}}},"until":{"second":{"default":{"zero":"خلال {0} من الثواني","one":"خلال {0} من الثواني","two":"خلال ثانيتين","few":"خلال {0} ثوانِ","many":"خلال {0} ثانية","other":"خلال {0} من الثواني"}},"minute":{"default":{"zero":"خلال {0} من الدقائق","one":"خلال {0} من الدقائق","two":"خلال دقيقتين","few":"خلال {0} دقائق","many":"خلال {0} دقيقة","other":"خلال {0} من الدقائق"}},"hour":{"default":{"zero":"خلال {0} من الساعات","one":"خلال {0} من الساعات","two":"خلال ساعتين","few":"خلال {0} ساعات","many":"خلال {0} ساعة","other":"خلال {0} من الساعات"}},"day":{"default":{"zero":"خلال {0} من الأيام","one":"خلال {0} من الأيام","two":"خلال يومين","few":"خلال {0} أيام","many":"خلال {0} يومًا","other":"خلال {0} من الأيام"}},"week":{"default":{"zero":"خلال {0} من الأسابيع","one":"خلال {0} من الأسابيع","two":"خلال أسبوعين","few":"خلال {0} أسابيع","many":"خلال {0} أسبوعًا","other":"خلال {0} من الأسابيع"}},"month":{"default":{"zero":"خلال {0} من الشهور","one":"خلال {0} من الشهور","two":"خلال شهرين","few":"خلال {0} شهور","many":"خلال {0} شهرًا","other":"خلال {0} من الشهور"}},"year":{"default":{"zero":"خلال {0} من السنوات","one":"خلال {0} من السنوات","two":"خلال سنتين","few":"خلال {0} سنوات","many":"خلال {0} سنة","other":"خلال {0} من السنوات"}}},"none":{"second":{"default":{"zero":"لا ثوان","one":"ثانية","two":"ثانيتان","few":"{0} ثوان","many":"{0} ثانيةً","other":"{0} ثانية"},"short":{"zero":"لا ثوان","one":"ثانية","two":"ثانيتان","few":"{0} ث","many":"{0} ث","other":"{0} ث"},"abbreviated":{"zero":"{0} ثانية","one":"{0} ثانية","two":"{0} ثانية","few":"{0} ثانية","many":"{0} ثانية","other":"{0} ثانية"}},"minute":{"default":{"zero":"لا دقائق","one":"دقيقة","two":"دقيقتان","few":"{0} دقائق","many":"{0} دقيقةً","other":"{0} دقيقة"},"short":{"zero":"لا دقائق","one":"دقيقة","two":"دقيقتان","few":"{0} د","many":"{0} د","other":"{0} د"},"abbreviated":{"zero":"{0} دقيقة","one":"{0} دقيقة","two":"{0} دقيقة","few":"{0} دقيقة","many":"{0} دقيقة","other":"{0} دقيقة"}},"hour":{"default":{"zero":"لا ساعات","one":"ساعة","two":"ساعتان","few":"{0} ساعات","many":"{0} ساعةً","other":"{0} ساعة"},"short":{"zero":"لا ساعات","one":"ساعة","two":"ساعتان","few":"{0} س","many":"{0} س","other":"{0} س"},"abbreviated":{"zero":"{0} ساعة","one":"{0} ساعة","two":"{0} ساعة","few":"{0} ساعة","many":"{0} ساعة","other":"{0} ساعة"}},"day":{"default":{"zero":"{0} يوم","one":"يوم","two":"يومان","few":"{0} أيام","many":"{0} يوماً","other":"{0} يوم"},"short":{"zero":"لا أيام","one":"يوم","two":"يومان","few":"{0} أيام","many":"{0} يوماً","other":"{0} يوم"},"abbreviated":{"zero":"{0}يومًا","one":"{0}يومًا","two":"{0}يومًا","few":"{0}يومًا","many":"{0}يومًا","other":"{0}يومًا"}},"week":{"default":{"zero":"لا أسابيع","one":"أسبوع","two":"أسبوعان","few":"{0} أسابيع","many":"{0} أسبوعاً","other":"{0} أسبوع"},"short":{"zero":"لا أسابيع","one":"أسبوع","two":"أسبوعان","few":"{0} أسابيع","many":"{0} أسبوعاً","other":"{0} أسبوع"}},"month":{"default":{"zero":"لا أشهر","one":"شهر","two":"شهران","few":"{0} أشهر","many":"{0} شهراً","other":"{0} شهر"},"short":{"zero":"لا أشهر","one":"شهر","two":"شهران","few":"{0} أشهر","many":"{0} شهراً","other":"{0} شهر"}},"year":{"default":{"zero":"لا سنوات","one":"سنة","two":"سنتان","few":"{0} سنوات","many":"{0} سنة","other":"{0} سنة"},"short":{"zero":"لا سنوات","one":"سنة","two":"سنتان","few":"{0} سنوات","many":"{0} سنة","other":"{0} سنة"}}}};
  ...
  TwitterCldr.NumberFormatter = (function() {
    function NumberFormatter() {
      this.all_tokens = {"default":{"positive":["","#,##0.###"],"negative":["-","#,##0.###"]},"decimal":{"positive":["","#,##0.###"],"negative":["-","#,##0.###"]},"long_decimal":{"positive":{"1000":["","0"," ألف"],"10000":["","00"," ألف"],"100000":["","000"," ألف"],"1000000":["","0"," مليون"],"10000000":["","00"," مليون"],"100000000":["","000"," مليون"],"1000000000":["","0"," بليون"],"10000000000":["","00"," بليون"],"100000000000":["","000"," بليون"],"1000000000000":["","0"," تريليون"],"10000000000000":["","00"," تريليون"],"100000000000000":["","000"," تريليون"]},"negative":{"1000":["-","0"," ألف"],"10000":["-","00"," ألف"],"100000":["-","000"," ألف"],"1000000":["-","0"," مليون"],"10000000":["-","00"," مليون"],"100000000":["-","000"," مليون"],"1000000000":["-","0"," بليون"],"10000000000":["-","00"," بليون"],"100000000000":["-","000"," بليون"],"1000000000000":["-","0"," تريليون"],"10000000000000":["-","00"," تريليون"],"100000000000000":["-","000"," تريليون"]}},"short_decimal":{"positive":{"1000":["","0"," ألف"],"10000":["","00"," ألف"],"100000":["","000"," ألف"],"1000000":["","0"," مليو"],"10000000":["","00"," مليو"],"100000000":["","000"," مليو"],"1000000000":["","0"," بليو"],"10000000000":["","00"," بليو"],"100000000000":["","000"," بليو"],"1000000000000":["","0"," ترليو"],"10000000000000":["","00"," ترليو"],"100000000000000":["","000"," ترليو"]},"negative":{"1000":["-","0"," ألف"],"10000":["-","00"," ألف"],"100000":["-","000"," ألف"],"1000000":["-","0"," مليو"],"10000000":["-","00"," مليو"],"100000000":["-","000"," مليو"],"1000000000":["-","0"," بليو"],"10000000000":["-","00"," بليو"],"100000000000":["-","000"," بليو"],"1000000000000":["-","0"," ترليو"],"10000000000000":["-","00"," ترليو"],"100000000000000":["-","000"," ترليو"]}},"currency":{"positive":["¤","#,##0.00"],"negative":["(¤","#,##0.00",")"]},"percent":{"positive":["","#,##0","%"],"negative":["-","#,##0","%"]}};
      this.tokens = [];
